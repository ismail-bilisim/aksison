...
export interface PrensipDialogData {
  prosedurId: number;
  nextMaddeNo: number;
}

@Component({
  selector: 'app-prosedur-prensip-dialog',
  standalone: true,
  imports: [CommonModule, FormsModule, DialogModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <div class="dialog-container p-4">
      <h5 class="mb-3"><i class="bi bi-bookmark-plus me-2"></i>Yeni Prensip Ekle</h5>
...
export class ProsedurPrensipDialogComponent {
  form = {
    maddeNo: 1,
    maddeAdi: '',
    icerik: ''
  ...
  constructor(
    @Inject(DIALOG_DATA) public data: PrensipDialogData,
    private readonly dialogRef: DialogRef<PrensipRequest | null>
  ) {

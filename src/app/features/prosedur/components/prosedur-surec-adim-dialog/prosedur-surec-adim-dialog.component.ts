...
export interface SurecAdimDialogData {
  prosedurId: number;
  nextMaddeNo: number;
}

@Component({
  selector: 'app-prosedur-surec-adim-dialog',
  standalone: true,
  imports: [CommonModule, FormsModule, DialogModule],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <div class="dialog-container p-4">
      <h5 class="mb-3"><i class="bi bi-list-ol me-2"></i>Yeni Süreç Adımı Ekle</h5>
      <div class="mb-3">
...
export class ProsedurSurecAdimDialogComponent {
  form = { maddeNo: 1, maddeAdi: '', icerik: '' };

  constructor(
    @Inject(DIALOG_DATA) public data: SurecAdimDialogData,
    private readonly dialogRef: DialogRef<SurecAdimRequest | null>
  ) {

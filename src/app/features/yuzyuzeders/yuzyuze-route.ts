...
import { YuzyuzedersBasvuruPageComponent } from './pages/yuzyuzeders-basvuru-page/yuzyuzeders-basvuru-page.component';
...
export const YUZYUZEDERS_ROUTES: Routes = [
  ...
  { path: 'basvuru/:id', component: YuzyuzedersBasvuruPageComponent },
